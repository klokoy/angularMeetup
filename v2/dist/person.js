System.register(['angular2/angular2', 'angular2/router', './personService'], function(exports_1) {
    ...
    var angular2_1, router_1, personService_1;
    var Person;
    return {
        setters:[
        ...
        execute: function() {
            Person = (function () {
                ...
                Person = __decorate([
                    ...
                    __metadata('design:paramtypes', [(typeof (_a = typeof router_1.RouteParams !== 'undefined' && router_1.RouteParams) === 'function' && _a) || Object, personService_1.PersonService])
                ], Person);
                return Person;
                var _a;
            })();
